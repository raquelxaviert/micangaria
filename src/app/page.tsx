...
export default function HomePage() {
  ...
  return (
    <div className="space-y-20">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/5 via-background to-secondary/5 min-h-[80vh] flex items-center">
        ...
        <div className="relative z-10 container mx-auto px-6 py-20 md:py-32 text-center">
          <div className="max-w-5xl mx-auto space-y-10">            <div className="space-y-6">              <Badge className="bg-accent/15 text-accent-foreground border-accent/30 px-6 py-3 text-base font-medium animate-bounce backdrop-blur-sm">
              ...
              <h1 className="text-6xl md:text-8xl font-headline text-primary leading-tight animate-fade-in">
                Descubra Seu{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button 
                asChild 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 py-5 text-lg font-semibold rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 transform"
              >
                <Link href="/products">
                  Explorar Coleção
      ...
      <section className="bg-gradient-to-r from-muted/30 to-accent/5 py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center p-8 border-0 bg-card/50 backdrop-blur-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-headline text-primary mb-4">Qualidade Garantida</h3>
            ...
            <Card className="text-center p-8 border-0 bg-card/50 backdrop-blur-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-headline text-primary mb-4">Entrega Rápida</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="text-center p-8 border-0 bg-card/50 backdrop-blur-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-headline text-primary mb-4">Troca Fácil</h3>
              <p className="text-muted-foreground">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-8 border-0 bg-card/80 backdrop-blur-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
